...
module.exports = function(grunt) {
    ...
    function distCssFiles() {
        return [{src: pathDist() + cog.getConfig('name') + '.css', dst: pathDist() + cog.getConfig('name') + '.min.css'}];
    }
    ...
    function distJsFiles() {
        return [{src: pathDist() + cog.getConfig('name') + '.js', dst: pathDist() + cog.getConfig('name') + '.min.js'}];
    }
     ...
     */
    function pathDist() {
        var ret = cog.getConfig('paths.dist', 'dist/');
        if (! /\/$/.test(ret)) {
            ret += '/';
        }
        return ret;
     ...
     */
    function pathDocs() {
        var ret = cog.getConfig('paths.docs', 'docs/');
        if (! /\/$/.test(ret)) {
            ret += '/';
        }
        return ret;
    ...
    function pathTemplate() {
        return cog.getConfig('paths.template', 'generated-templates.js');
    }
